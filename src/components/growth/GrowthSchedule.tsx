...
const GrowthSchedule = ({ logs } : GrowthScheduleProps) => {
    ...
    return (
        <div className={`flex flex-col rounded-[16px] p-[16px] gap-[10px] border-[1px] ${status === "PENDING" ? "border-primary-blue-100" : "border-primary-blue-500"}`}>
            <div className={`flex flex-col gap-[5px] ${status === "PENDING" ? "opacity-50" : "opacity-100"}`}>
