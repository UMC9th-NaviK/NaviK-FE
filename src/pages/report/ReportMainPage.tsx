      ...
      <div className="flex pr-[16px] pl-[16px]">
        <div className="relative flex flex-1 items-center gap-[10px] overflow-hidden rounded-full bg-white p-[10px] shadow-[0_0_10px_0_#DBEBFE]">
          <div className="flex h-[65px] w-[65px] items-center justify-center rounded-full bg-[conic-gradient(from_0deg,#4E83F9,#DBEBFE)]">
            <img
              src={profile?.profileImageUrl ? profile.profileImageUrl : profileImage}
              alt="프로필 이미지"
          ...
          <div className="flex-col items-center justify-center">
            ...
            <div className="flex">
              <span
                className={`text-[#4E83F9] ${mappedRole === 'DESIGNER' ? 'text-body-14B' : 'text-body-16B'}`}
              >
                {mappedRole}
              </span>
              <p className={`${mappedRole === 'DESIGNER' ? 'text-body-14B' : 'text-body-16B'}`}>
                의 성공적인 항해를 위해서🔥
              </p>
            </div>
          </div>
        ...
        <div className="flex w-full flex-1 items-center justify-center gap-[16px]">
          ...
          >
            <div className="flex flex-col gap-[10px]">
              ...
              <div className="text-body-14M flex flex-col gap-[8px] text-center">
              ...
              >
                ...
                {type === 'up' ? (
                  <p className="text-body-14M absolute bottom-0 pb-[12px] text-start text-[#11111199]">
                    지난 달 대비 <br />
                    <span className="text-body-16M text-[#4E83F9]"> {scoreRate}% </span> 상승했어요!
                  </p>
                ) : (
                  <p className="text-body-14M absolute bottom-0 pb-[12px] text-start text-[#11111199]">
                    지난 달 대비 <br />
                    <span className="text-body-16M text-[#4E83F9]"> {scoreRate}% </span> 하강했어요.
                  </p>
                )}
              </button>
